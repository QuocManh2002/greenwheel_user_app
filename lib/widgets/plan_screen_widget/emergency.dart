    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            location.emergencyContacts![0].name == null
                ? 'Không có địa chỉ'
                : location.emergencyContacts![0].name!,
        ...
        Padding(
          ...
          child: Row(
            children: [
              Text(
                location.emergencyContacts![0].phone == null
        ...
        Padding(
          padding: const EdgeInsets.only(left: 50, right: 40),
          child: Text(
            location.emergencyContacts![0].address == null ? 'Không có địa chỉ':location.emergencyContacts![0].address! ,
            style: const TextStyle(fontSize: 16),
          ),
        ),
        const SizedBox(
